    ...
    return (
        <div className={styles.dragonWrap}>
            ...
            <div className={styles.dragonAffordaleDiscription}>
                <p>
                    We Purchase all the tools officially & Share it in groups to many peoples that’s
                    how a single purchased account is used by multiple peoples. We charge you a
                    small amount from each user & hence the funds collected & we are able to share
                    those expensive premium tools at more affordable rates.
                </p>
            </div>
        </div>
    );
